...
parser.add_argument('--dataset', type=str, default='qnrf', help='dataset name: qnrf, nwpu, sha, shb, synth, gcc')
...
if args.dataset.lower() == 'qnrf':
	dataset = crowd.Crowd(args.dataset.lower(), os.path.join(data_path, 'test'), crop_size, 8, method='val')
elif args.dataset.lower() == 'nwpu':
	dataset = crowd.Crowd(args.dataset.lower(), os.path.join(data_path, 'val'), crop_size, 8, method='val')
elif args.dataset.lower() == 'sha' or args.dataset.lower() == 'shb':
	dataset = crowd.Crowd(args.dataset.lower(), os.path.join(data_path, 'test_data'), crop_size, 8, method='val')
else:
