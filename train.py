...
def parse_args():
    ...
    parser.add_argument(
        "--save-dir", default="ckpts/SHA", help="checkpoint save directory"
    )
    parser.add_argument(
        "--dataset",
        default="sha",
    ...
    parser.add_argument(
        "--mix-val", type=str2bool, default=False, help="mix dataset with synth"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--val-start", type=int, default=50, help="the epoch start to val"
    )
