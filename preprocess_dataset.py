...
parser.add_argument(
    "--dataset", default="qnrf", help="dataset name, only support qnrf and nwpu"
)
parser.add_argument("--input-path", default="data/QNRF", help="original data directory")
parser.add_argument(
    "--output-path", default="data/QNRF-Train-Val-Test", help="processed data directory"
)
parser.add_argument(
    "--augmentation", type=str2bool, default=False, help="processed data directory"
)
